...
#ifndef CYPM1211_40LQXIT
    #error "Unexpected target MCU; expected CYPM1211-40LQXIT. There may be an inconsistency between the *.modus file and the makefile target configuration device sets."
#endif
#endif
